...
const StyledFooter = styled('footer', {
  ...
  marginTop: 'auto', // Push footer to bottom when possible
});
      ...
      <FooterContainer>
        <TopSection>
          <LeftSection>
            ...
            <FooterNav>
              <FooterLink href="https://www.boston.gov/departments/innovation-and-technology/terms-use-and-privacy-policy-city-boston-digital-services">
                PRIVACY POLICY
              </FooterLink>
              <FooterLink href="https://www.boston.gov/departments/mayors-office/contact-boston-city-hall">
                CONTACT US
              </FooterLink>
              <FooterLink href="https://www.boston.gov/career-center">JOBS</FooterLink>
              <FooterLink href="https://bostonma.govqa.us/WEBAPP/_rs/(S(den310hnrpqz2rzh5lgbgsby))/SupportHome.aspx">
                PUBLIC RECORDS
              </FooterLink>
              <FooterLink href="https://www.boston.gov/departments/language-and-communications-access/notice-accommodations">

        ...
        for (const marker of markers) {
          ...
          if (docSnap.exists()) {
            ...
            if (orgData.Type_Of_Service) {
              ...
              const services =
                typeof orgData.Type_Of_Service === 'string'
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.description}>
          Here, you will find a comprehensive map of available resources, services, and event
          locations. Refer to the legend on the right for icons.
        </p>
      </div>

      {/* Filters */}
      <div style={styles.filtersContainer} ref={filtersRef}>
        <button style={styles.filtersButton} onClick={() => setShowFilters(!showFilters)}>
          <FiFilter />
          Filter Resources
          ...
          <div style={styles.activeFilters}>
            {selectedServices.map(service => (
              <div key={service} style={styles.filterTag}>
                {service}
                <span style={styles.removeFilterButton} onClick={() => removeService(service)}>
                  <FiX />
                </span>
              </div>
            ))}
      ...
      <div style={styles.mapContainer}>
        ...
        <Map markers={filteredMarkers} center={downtownBostonCenter} />
      </div>
    </div>
  );
}
